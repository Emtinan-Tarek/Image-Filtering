...
namespace IMAGE_FILTERS
{
    public class ImageOperations
    {
        ...
        ////9-K'th_Kth_Smallest_Largest_Element
        public static byte[] Kth_Smallest_Largest(byte[] Array, int ArrayLength, byte Max, byte Min, int Wmax)
        {
            byte size = (byte)(Wmax * Wmax);
            ...
            int sum = 0;
            byte  avg = 0;
            for (int i = 0; i < arr1.Length; i++) { arr1[i] = 0; }
            for (int i = 0; i < arr2.Length; i++) { arr2[i] = 0; }
            ...
            avg = (byte)(sum / arr2.Length);

            Array[(ArrayLength/2)] = avg;
        ...
        public static byte Filter1(byte[,] ImageMatrix, int x, int y, int Wmax, int Sort)
        {
            ...
            else if (Sort == 9) Array = Kth_Smallest_Largest(Array, ArrayLength, Max, Min, Wmax);
